...
async function loadModules() {
  ...
  const [store, { withRouter, moment }, { default: Lightbox }, { Icon }, { ReactPhotoSphereViewer }] = await Promise.all([
  ...
  cachedModules = { store, withRouter, moment, Lightbox, Icon, ReactPhotoSphereViewer }
