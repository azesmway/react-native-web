...
export default function MapChatComponent(props) {
  ...
  const loadModules = async () => {
    ...
    const [store, { withRouter, theme, t }, { chatServiceGet }, MapViewModule, { Marker, ClusterProps, MarkerClusterer }, Spinner, { Modal, Portal }, { Icon }, { isMobile }, Geolocation] =
      await Promise.all([
        import('app-store-web'),
        import('app-utils-web'),
        import('app-services-web'),
        import('@teovilla/react-native-web-maps'),
        import('@teovilla/react-native-web-maps'),
